        ...
        <div className="cards-grid">
          ...
          <div className={`card grow-card ${isVisible ? 'animate-left' : ''}`}>
            <div className="card-content">
              ...
              <p className="card-description">
              To turn India's human resources as a start-up source
              </p>
          ...
          <div className={`card partner-card ${isVisible ? 'animate-right' : ''}`}>
            <div className="card-content">
              ...
              <ul className="card-description">
                <li>Create India's Largest STARTUPRENEUR community among Universities</li>
                <li>Make entrepreneurship contagious</li>
                <li>Endeavour for unicorns at a ratio 1:100</li>
